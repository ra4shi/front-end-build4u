...
function HomePage() {
    ...
    const getBanner = async () => {
        try {
            const response = await axios.post("https://buildforyou.site/api/user/banners", {});
  ...
  <div key={index} style={{ display: index === currentBannerIndex ? 'block' : 'none' }}>
    <div className="relative bg-white">
      <img
        ...
        alt={`Banner ${index}`}
      />
      <div className="absolute inset-0 flex flex-col items-baseline ">
        <p className="text-2xl font-semibold leading-9 text-white lg:text-4xl md:text-2xl">
          {banner.title}
        </p>
        <p className="text-base font-medium leading-none text-gray-800 bg-white px-2 py-2 max-w-[142px] mt-3">
          {banner.link}
        </p>
      </div>
    </div>
                ...
                <div class="w-full lg:flex items-center gap-6 mt-10">
                    <div class="lg:w-1/2">
                        <div class="bg-white dark:bg-gray-800  border rounded-md border-gray-200 dark:border-gray-700  relative sm:p-10 p-6">
                            ...
                            <p class="text-base leading-6 text-gray-600 dark:text-white  mt-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p>
                        ...
                        <div class="flex items-center mt-7">
                            ...
                            <div class="flex flex-col items-start ml-4">
                                ...
                                <p class="text-base leading-4 mt-2 text-center text-gray-600 dark:text-white ">Marketing Manager</p>
                            </div>
                        </div>
                    </div>
                    <div class="lg:w-1/2 lg:mt-0 mt-16">
                        ...
                        <div class="flex items-center mt-7">
                            ...
                            <div class="flex flex-col items-start ml-4">
                                ...
                                <p class="text-base leading-4 mt-2 text-center text-gray-600 dark:text-white ">Digital Technic</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div class="lg:w-10/12 w-full">
                    <p class="font-normal text-sm leading-3 text-indigo-700 dark:text-indigo-500 hover:text-indigo-800 cursor-pointer">About</p>
                    <h2 class="xl:w-8/12 lg:w-10/12 w-full font-bold text-gray-800 dark:text-white lg:text-4xl text-3xl lg:leading-10 leading-9 mt-2">We are here to make great design accessible and delightfull for everyone</h2>
                ...
                <div class="lg:mt-16 sm:mt-12 mt-16 flex lg:flex-row justify-between flex-col lg:gap-8 gap-12">
                    ...
                    <div class="lg:flex items-center w-full lg:w-1/2">
                        <img class="lg:block hidden w-full" src="https://images.pexels.com/photos/2760243/pexels-photo-2760243.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="people discussing on board" />
