    ...
    const fetchProjects = async () => {
      try {
        const response = await axios.post(
          `https://buildforyou.site/api/user/project-details/${projectId}`,
          {},
          {
            headers: {
      ...
      <div className="cardss block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-center items-center  ">
            ...
            <Link to={`/appointmentbooking/${company._id}`}>
              <div className="appointments-section bg-blue-700 mt-4 hover:bg-neutral-600 p-4 rounded-lg text-center">
                <h2 className="text-xl font-medium">Appointments</h2>
                <h2 className="text-xl font-medium">₹{projects.appointmentfee}</h2>
              </div>
            </Link>
