  ...
  const getdata = async () => {
    try {
      const response = await axios.post(
        "https://buildforyou.site/api/user/get-user-info-by-id",
        {},
        {
          headers: {
    ...
    <>
      <div className="container">
        ...
        <div className="home-container-right">
          <h1 className="text-center text-2xl font-semibold mb-6">User Profile</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-1">
                <div className="bg-white shadow-lg rounded-lg p-6 text-center">
                  <img
                    src={`https://buildforyou.site/public/${data?.profile}`}
              ...
              <div className="md:col-span-1">
                <div className="bg-white shadow-lg rounded-lg p-6">
                  <div className="mb-4">
                    <h6 className="text-lg font-semibold mb-1">Full Name</h6>
                    <p className="text-gray-600">{data?.name}</p>
                  </div>
                  <hr className="my-4" />
                  <div className="mb-4">
                    <h6 className="text-lg font-semibold mb-1">Mobile</h6>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition duration-500 ml-2"
                    >
                      Log Out
                    </Link>
                  </div>
