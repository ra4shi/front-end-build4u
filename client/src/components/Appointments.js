...
function Appointments() {
        ...
        const fetchAppointment = async () => {
            ...
            try {
                const response = await axios.post(
                    'https://buildforyou.site/api/user/appointments',
                    {},
                    {
                        headers: {
    ...
    const startChat=(id,user_id)=>{
      
        navigate('/chat',{state:{id,user_id}})
        
       }
       const sendId=(data)=>{
        console.log("prevdata",data)
        navigate("/getReview",{state: data})
       }
    ...
    return (
        <div>
          <nav className="bg-white p-4 md:flex md:items-center md:justify-between">
            ...
            <div>
                <div class="px-4 md:px-10 items-center py-4 md:py-7">
                    <div class="sm:flex items-center justify-between">
                        <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800 dark:text-white">Appointments</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-900 px-4 md:px-10 pb-5">
                    <div class="overflow-x-auto">
                        <table class="w-full whitespace-nowrap">
                            <thead>
                                <tr>
                                    <th class="pl-16">Project</th>
                                    <th class="pl-16">Payment Status</th>
                                    <th class="pl-16">Amount</th>
                                    <th class="pl-16">Category</th>
                                    <th class="pl-16">Company</th>
                                    <th class="pl-16">Contruction Status</th>
                                    <th class="pl-16">Appointment Status</th>
                                    <th class="pl-16">Chat</th>
                                    <th class="pl-16">Rating</th>
                                </tr>
                            </thead>
                            <tbody>
                                {appointment?.map((appointment, index) => (
                                    ...
                                    >
                                        ...
                                        <td>
                                            <p class="pl-16">{appointment.amount}</p>
                                        </td>
                                        <td>
                                            <p class="pl-16">{appointment.category}</p>
                                        </td>
                                        <td>
                                            <p class="pl-16">{appointment.companyName}</p>
                                        </td>
                                        <td>
                                            <p class="pl-16">{appointment?.contructionstatus}</p>
                                        </td>
                                        <td>
                                            <p class="pl-16">{appointment.appointmentstatus}</p>
                                        </td>
                                        ...
                                        <td>
                                               ...
                                               <button class="pl-16 "  onClick={()=>{startChat(appointment._id,appointment.user_id)}} >
                                               Chat
                                           </button>
                                        ...
                                        <td>
                                            ...
                                            {appointment.contructionstatus !== "pending" && (
                                             
                                                <button onClick={() => {
                                                    sendId(appointment._id)
                                                }}
