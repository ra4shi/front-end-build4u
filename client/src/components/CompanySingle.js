        ...
        const fetchCompany = async () => {
            try {
                const response = await axios.post(
                    `https://buildforyou.site/api/user/company-details/${companyId}`,
                    {},
                    {
                        headers: {
        ...
        <div>
            ...
            <div className="flex flex-col items-center">
                <img
                    ...
                    src={`/project_images/${company.image && company.image[0]}`}
                    alt={`Company 0`}
                />
                ...
                <br />
                <br />
                <h1 className="text-3xl font-semibold">{company.companyname}'s services</h1>
            </div>
            ...
            <p class="font-serif text-xl font-extrabold leading-none tracking-tight lg:text-2xl">
                Rating And Review's Information
            </p>
            ...
            {review?.map((reviews, index) => (
                ...
                <div class="w-full lg:flex items-center gap-6 mt-10">
                    ...
                    <div class="lg:w-1/2 items-center lg:mt-0 mt-16">
                        <div class="bg-white dark:bg-gray-800  dark:bg-gray-800  border rounded-md border-gray-200 dark:border-gray-700  relative sm:p-10 p-6">
                            ...
                            <p class="text-base leading-6 text-gray-600 dark:text-white  mt-4">{reviews.review}</p>
                        ...
                        <div class="flex items-center mt-7">
                            ...
                            <div class="flex flex-col items-start ml-4">
                                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-white ">{reviews.username}</p>
                                <p className="text-gray-700 dark:text-gray-300">Completed User</p>
